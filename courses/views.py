...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def get_form(self, model, *args, **kwargs):
        # exclude some fields and let other fields be inlcuded automatically
    ...
    def post(self, request, module_id, model_name, id=None):
        """Works for both update and create. Not the URL patterns"""
        form = self.get_form(
...
class ContentDeleteView(View):
    def post(self, request, id):
        content = get_object_or_404(Content, id=id, module__course__onwer=request.user)
        module = content.module
        content.item.delete()  # delete Text, Video, File,Image obj
        content.delete()  # delete content object
